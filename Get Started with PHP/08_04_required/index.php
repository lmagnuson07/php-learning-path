	...
	<?php
    // null coalescing operator - says if form complete is not null, use form complete, else set everything to true.
    // syntactic sugar for the common case of needing a ternary in conjunction with isset()
	$form_complete ?: true;
	if ( $form_complete ) {
