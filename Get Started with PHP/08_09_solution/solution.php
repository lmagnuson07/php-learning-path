<?php 
	...
	function send_message( $form_data ) {
		...
		$subject = "Contact Form Filled out. Reason: $reason";
		$box_message = filter_var( strip_tags( trim( $form_data['message'] ) ), FILTER_SANITIZE_ADD_SLASHES );
...
<?php
//  All three line below perform the same thing
//    $form_is_complete = $form_is_complete ?: true;
//    $form_is_complete = $form_is_complete ?? true;
